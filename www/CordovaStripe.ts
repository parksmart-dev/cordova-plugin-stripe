...
export namespace CordovaStripe {
  ...
  export type PaymentSuccessCallback = (result: PaymentMethod) => void;
  ...
  export class Plugin {
    ...
    static payWithGooglePay(options: GooglePayOptions, success: any = NOOP, error: ErrorCallback = NOOP) 
    {
